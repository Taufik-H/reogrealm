            ...
            <div className="flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
              <div className="w-full">
                ...
                <input
                  ...
                  id="hero-input"
                  name="hero-input"
                  className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-white focus:ring-white disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
      ...
      <footer className="bg-red-500">
        <div className="mx-auto max-w-5xl px-4 py-5 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-white">
            Jangan lewatkan kesempatan untuk menjadi bagian dari komunitas
            ReogRealm. Bergabunglah sekarang dan saksikan keindahan seni Reog
            bersama-sama.
          </p>
